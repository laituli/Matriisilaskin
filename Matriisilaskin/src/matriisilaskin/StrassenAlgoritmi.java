...
public class StrassenAlgoritmi {
    ...
    static double[][] strassenMultiplication(double[][] a, double[][] b, int n) {
        // limit case
        if (n == 1) {
    ...
    static double[][] plus(double[][] a, double[][] b, int ai, int aj, int bi, int bj, int n) {
    ...
    static double[][] minus(double[][] a, double[][] b, int ai, int aj, int bi, int bj, int n) {
